<template>
  <div>
    ...
    <v-card v-else class="elevation-0 pt-0">
      ...
      <v-card-subtitle> Last updated: {{ user.updated_at }} </v-card-subtitle>
                    ...
                    <v-card>
                      ...
                      <v-form ref="form_password">
                            ...
                            <v-row>
                              <v-col cols="12">
                                <v-text-field
                                  ...
                                  :error-messages="password_errors.old_password"
                                  @input="
                                    () => {
                              ...
                              <v-col cols="12">
                                <v-text-field
                                  ...
                                  :error-messages="password_errors.password"
                                  @input="
                                    () => {
                              ...
                              <v-col cols="12">
                                <v-text-field
                                  ...
                                  :rules="password_rules.password_confirmation"
                                  :error-messages="
                        ...
                        <v-card-actions>
                          ...
                          <v-btn color="primary" text @click="onUpdatePassword">
                            Save
                          </v-btn>
                        </v-card-actions>
                      </v-form>
    ...
    return {
      ...
      rules: {
        ...
        first_name: [
          ...
          (v) =>
            v.length <= 100 || "First name must be less than 100 characters",
        ],
        middle_name: [],
        last_name: [
          (v) => !!v || "Last name is required",
          (v) =>
            v.length <= 100 || "Last name must be less than 100 characters",
        ],
        suffix: [],
