                        ...
                        <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" md="4" v-if="paid_through_fund">
                                        <v-text-field
                                            label="Amount"
                                        ></v-text-field>
                                    </v-col>
                                ...
                                <v-row>
                                    <v-col>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="green--text">Amount to reimburse</td>
                                                    <td> : </td>
                                                    <td>0</td>
                                                </tr>
                                                <tr>
                                                    <td class="green--text">Amount to replenish</td>
                                                    <td> : </td>
                                                    <td>0</td>
                                                </tr>
                                                <tr>
                                                    <td class="green--text">Total Amount</td>
                                                    <td> : </td>
                                                    <td>0</td>
                                                </tr>
                                            </tbody>
