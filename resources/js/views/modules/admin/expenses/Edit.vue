...
export default {
    ...
    methods: {
            ...
            this.loadEmployees().then(
                axios
                    ...
                    .then(response => {
                        ...
                        _this.sub_types.unshift({ id: null, name: "None", limit: null });
                        _this.form.sub_type = data.sub_type == null ? { id: null, name: "None", limit: null } : data.sub_type;
        ...
        onSave() {
            ...
            // console.log(this.form.sub_type.id);
