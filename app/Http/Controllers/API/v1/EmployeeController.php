...
class EmployeeController extends Controller
{
    ...
    public function store(EmployeeStoreRequest $request)
    {
        ...
        $message = "Employee created successfully"; // return message
        ...
        $employee->fund = request('fund') ?? 0;

        $employee->remaining_fund = request('fund') ?? 0;
        ...
        return $this->successResponse(new EmployeeResource($employee), $message, 201);
    }
    ...
    {
        $message = "Employee retrieved successfully."; // return message
        ...
        return $this->successResponse(new EmployeeShowResource($employee), $message, 200);
    }
    ...
    public function update(EmployeeUpdateRequest $request, $id)
    {
        ...
        $message = "Employee updated successfully"; // return message
    ...
    {
        $message = "Employee deleted successfully"; // return message
    ...
    */
    ...
    {
        $message = "Employee restored successfully."; // return message
        ...
        if (request()->has("ids")) {
            ...
            $message = "Employee(s) restored successfully.";
        } else {
            $employee = Employee::withTrashed()->findOrFail($id);
    ...
    /**
     * Update settings of the specified resource from storage.
     *
     * @param  mixed $request
     * @param  mixed $id
     * @return void
    ...
    {
        $message = "Employee settings updated successfully."; // return message
    ...
    /**
     * Update fund of the specified resource from storage.
     *
     * @param  mixed $request
     * @param  mixed $id
     * @return void
    ...
    {
        $message = "Employee fund updated successfully."; // return message
