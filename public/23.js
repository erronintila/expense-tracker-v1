...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onDelete: function onDelete() {
      ...
      this.$confirm("Do you want to cancel adjustment(s)?").then(function (res) {
        if (res) {
          axios["delete"]("/api/adjustments/".concat(_this.selected[0].id), {
            params: {
    ...
    formatDate: function formatDate(date, format) {
      return date == null ? "" : !(function webpackMissingModule() { var e = new Error("Cannot find module ''"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(date).format(format);
    }
  },
  watch: {
    params: {
