    ...
    onDelete: function onDelete() {
      ...
      this.$confirm("Do you want to delete expense(s)?").then(function (res) {
        if (res) {
          ...
          _services_ExpenseDataService__WEBPACK_IMPORTED_MODULE_5__["default"]["delete"](ids).then(function (response) {
    ...
    onRestore: function onRestore() {
      ...
      this.$confirm("Do you want to restore expenses(s)?").then(function (res) {
        if (res) {
          ...
          _services_ExpenseDataService__WEBPACK_IMPORTED_MODULE_5__["default"].restore(ids).then(function (response) {
