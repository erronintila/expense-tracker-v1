  ...
  methods: {
    onSave: function onSave() {
      ...
      if (this.$refs.form.validate()) {
        _services_UserDataService__WEBPACK_IMPORTED_MODULE_2__["default"].updateProfile(this.form.id, {
          code: this.form.code,
    ...
    onUpdatePassword: function onUpdatePassword() {
      ...
      if (this.$refs.form_password.validate()) {
        _services_UserDataService__WEBPACK_IMPORTED_MODULE_2__["default"].updatePassword(this.form.id, {
