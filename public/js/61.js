...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ */ "./resources/js/views/pages/index.vue");
//
//
//
//
  ...
  methods: {
    onSave: function onSave() {
      ...
      if (this.$refs.form_password.validate()) {
        ___WEBPACK_IMPORTED_MODULE_0__["default"].updatePassword(this.form.id, {
          old_password: this.old_password,
          password: this.password,
          password_confirmation: this.password_confirmation
        }).then(function (response) {
          _this2.mixin_successDialog(response.data.status, response.data.message); // this.$store.dispatch("AUTH_USER");
