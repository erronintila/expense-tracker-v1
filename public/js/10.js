...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: {
    ...
    presets: {
      ...
      "default": function _default() {
        return ["Custom", "Today", "This Week", "This Month", "This Year"];
      }
    }
  },
  data: function data() {
  ...
  methods: {
    selectPreset: function selectPreset() {
      console.log(this.selectedPreset);
    },
    onSave: function onSave() {
      if (this.dates && this.dates.length == 2) {
        var sortedDates = this.dates.sort(function (a, b) {
  ...
  watch: {
    selectedPreset: function selectedPreset() {
      console.log(this.selectedPreset);
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    DateRangePicker2: _components_datepicker_DateRangePicker__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  data: function data() {
    return {
      loading: true,
