...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getData: function getData() {
      ...
      _services_JobDataService__WEBPACK_IMPORTED_MODULE_0__["default"].show(_this.$route.params.id).then(function (response) {
    ...
    onSave: function onSave() {
      ...
      if (_this.$refs.form.validate()) {
        ...
        _services_JobDataService__WEBPACK_IMPORTED_MODULE_0__["default"].update(_this.$route.params.id, data).then(function (response) {
