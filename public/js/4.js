...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    default_description: function default_description() {
      return "Expense Report Summary (".concat(this.form.from, " - ").concat(this.form.to, ")");
    },
    balance: function balance() {
      return this.total - this.paid;
    },
    selectedExpenses: function selectedExpenses() {
      if (this.form) {
    ...
    dateRange: {
      ...
      set: function set(value) {
        ...
        this.form.from = moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf("week").format("YYYY-MM-DD");
        this.form.to = moment__WEBPACK_IMPORTED_MODULE_0___default()().endOf("week").format("YYYY-MM-DD");
      }
    }
  },
  watch: {
    ...
    expenseReportForm: {
      ...
      handler: function handler(newValue, oldValue) {
        ...
        this.form = newValue;
        this.dateRange = [newValue.from, newValue.to];
  ...
  return _c(
    ...
    [
      ...
      _c("v-data-table", {
                    ...
                    ? _c(
                        ...
                        [
                          _c("div", { staticClass: "d-inline" }, [
                            _vm._v(
                              "\n                    " +
                                _vm._s(_vm.selectedExpenses.length) +
                                " Item(s) Selected\n                "
                            )
                          ]),
                          _vm._v(" "),
        ...
        model: {
          value: _vm.form.expenses,
          callback: function($$v) {
            _vm.$set(_vm.form, "expenses", $$v)
          },
          expression: "form.expenses"
        }
      }),
      _vm._v(" "),
      _vm.expenseReportErrors.expenses.length > 0
        ? _c("div", { staticClass: "red--text" }, [
            _c("small", [_vm._v(_vm._s(_vm.expenseReportErrors.expenses[0]))])
          ])
        : _vm._e(),
      _vm._v(" "),
      _c(
