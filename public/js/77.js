  ...
  methods: {
    getData: function getData() {
      ...
      return new Promise(function (resolve, reject) {
        !(function webpackMissingModule() { var e = new Error("Cannot find module '../../../../services/ExpenseDataService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).show(_this.$route.params.id).then(function (response) {
          var _data$details;
    ...
    onSave: function onSave(value) {
      ...
      !(function webpackMissingModule() { var e = new Error("Cannot find module '../../../../services/ExpenseDataService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).update(this.$route.params.id, value).then(function (response) {
